...
public class TreeNodeRSPQ<V> extends TreeNode<V> {
    ...
    private Collection<TreeNodeRSPQ> children;
    ...
    public Collection<TreeNodeRSPQ> getChildren() {
        return children;
    }
     ...
     * @return
     */
    public int getFirstCM(V vertex) {
