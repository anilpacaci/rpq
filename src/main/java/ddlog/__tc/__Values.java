...
public final class __Values extends Table {
  ...
  public __ValueTable values(int j) { return values(new __ValueTable(), j); }
  public __ValueTable values(__ValueTable obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static void start__Values(FlatBufferBuilder builder) { builder.startObject(1); }
